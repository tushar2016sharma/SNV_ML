...
Original file is located at
    https://colab.research.google.com/drive/1x5K_b6s2wvWzH6RNu8M8m41i-gteemyk
"""
...
def tune_and_train(X_train, y_train, X_val, y_val, models_dir, sample_id):
    ...
    model.fit(X_train, y_train, validation_data=(X_val, y_val), epochs=100, callbacks=[stop_early], verbose=2)
